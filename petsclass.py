...
print(f"average lengeth is {cat.getAverageNameLength()}")

for x in range (8):
    cat.speak("hello")

print(f"cat initial age is {cat.age}")
print(f"number of times cat spoke is {cat.speak_counter}")
print(f"age of cat is {cat.new_age}")
